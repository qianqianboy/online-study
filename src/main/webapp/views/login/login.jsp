                        ...
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                        	<div class="form-top">
                        		<div class="form-top-left">
                        			<h3>
                                        <c:if test="${pageContext.response.locale=='zh_CN'}">当前语言: 中文简体</c:if>
                                        <c:if test="${pageContext.response.locale=='en_US'}">Current language:English</c:if>
                                        <c:if test="${pageContext.response.locale=='ja'}">現在の言語:日本語</c:if>
                                        <br/>
                                        Switch to:<a href="?locale=zh_CN">中文简体  </a><a href="?locale=en_US">English  </a><a href="?locale=ja">日本語</a>
                                    </h3>
                            		<%--<p>请输入邮箱和密码进行登录</p>--%>
                        		</div>
                            ...
                            <div class="form-bottom">
			                    <form role="form" id="login-form" action="/student/login" method="post" class="login-form">
			                    	<div class="form-group">
			                    		<label class="sr-only" for="form-username">邮箱</label>
			                        	<input type="email" name="email" placeholder="<spring:message code="email"/>" class="form-username form-control" id="form-username">
			                        </div>
			                        <div class="form-group">
