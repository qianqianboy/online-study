...
<div class="content">
    ...
    <ul class="nav nav-tabs" rolw="tablist">
        ...
        <li role="presentation">
            <a href="/views/teacher/upload.jsp" role="tab">我要传课</a>
        </li>
        <%--<li role="presentation" >--%>
    ...
    <div class="col-md-8 report-item clearfix" style="font-size: larger">
       <table style="text-align: justify-all">
           <tr>
               ...
               <td> <img src="/test/${sessionScope.TEACHER.image}" width="45" height="50"></td>
           </tr>
           <tr>
           ...
           <tr>
               <td><span style="color: #0ace9d">教师工号：</span></td>
               <td>${sessionScope.TEACHER.number}</td>
           </tr>
           <tr>
           ...
           <tr>
               ...
               <td><fmt:formatDate  value="${sessionScope.TEACHER.createTime}" pattern="yyyy年MM月dd日 HH时mm分ss秒"/></td>
           </tr>
       </table>
    </div>
    <div class="col-md-2" style="font-size: larger">
        <br><br>
        <a href="/teacher/updateInfo/${sessionScope.TEACHER.id}">修改个人资料</a>
    </div>
</c:if>
    <c:if test="${editor!=null}">
        <div class="col-md-8 report-item clearfix" style="font-size: larger">
