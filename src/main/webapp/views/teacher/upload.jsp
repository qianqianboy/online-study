        ...
        <div class="collapse navbar-collapse" id="header-navbar-collapse">
            ...
            <div class="navbar-right btns">
                ...
                <li class="dropdown ">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="" href="/teacher/info">个人中心</a></li>
    ...
    <div class="user-username ">
        <a class="username" href="/user/13" target="_blank">
            ${sessionScope.TEACHER.name}
                    ...
                    <div class="userinfo-banner-status">
                        <span>${sessionScope.TEACHER.intro}</span>
                    </div>
                </div>
            </div>
...
<div class="content">
    ...
    <ul class="nav nav-tabs" rolw="tablist">
        ...
        <li role="presentation" class="active">
            <a href="/teacher/upload" role="tab">我要传课</a>
        </li>
        <%--<li role="presentation" >--%>
...
<c:if test="${editor==null}">
    <div class="col-md-12 report-item clearfix" style="font-size: larger">

        <form id="defaultForm" action="/teacher/upload" method="post" enctype="multipart/form-data">
            <input type="hidden" name="teacherId" value="${sessionScope.TEACHER.id}">
            <input type="hidden" name="author" value="${sessionScope.TEACHER.name}">
            <table class="table table-bordered table-hover table-striped">
                <tr class="info">
                    <th class="text-danger">上传课程封面
                    </th>
                    <td>
                        <div class="file-container  col-md-offset-4" style="display:inline-block;position:relative;overflow: hidden;">
                            <button class="btn btn-success fileinput-button" type="button" style="text-align: center">选择一张图片</button>
                            <input type="file" name="imageName" id="jobData" onchange="loadFile(this.files[0])" style="position:absolute;top:0;left:0;font-size:34px; opacity:0">
                            </div>
                ...
                <tr>
                    <th class="text-danger">课程所属分类</th>

                    <td>
                        <button type="button" class="btn bg-info text-danger col-md-offset-4"><select name="subjectId">
                            <option value="10000" selected="selected">Java</option>
                            <option value="10001">区块链</option>
                            <option value="10002"}>Python</option>
                            <option value="10003"}>C++</option>
                            <option value="10004"}>Linux</option>
                            <option value="10005"}>Web</option>
                            <option value="10006"}>PHP</option>
                            <option value="10007"}>NodeJS</option>
                            <option value="10008"}>Android</option>
                            <option value="10009"}>GO</option>
                            <option value="10010"}>Spark</option>
                            <option value="10011"}>Hadoop</option>
                            <option value="10012"}>Ruby</option>
                            <option value="10013"}>R</option>
                            <option value="10014"}>Git</option>
                            <option value="10015"}>SQL</option>
                            <option value="10016"}>NoSQL</option>
                            <option value="10017"}>算法</option>
                            <option value="10018"}>Docker</option>
                            <option value="10019"}>Swift</option>
                            <option value="10020"}>Windows</option>
                            <option value="10021"}>Scala</option>
                            <option value="10022"}>HTML5</option>
                        </select>
                        </button>
                    </td>
                </tr>
                ...
                <tr>
                    <th class="text-danger">课程标题</th>
                    <td>
                        <div class="form-group col-md-8 col-md-offset-2">
                            <input type="text" name="title" class="form-control input-sm" placeholder="输入课程标题">
                        </div>
                    </td>
                </tr>

                <tr>
                    <td colspan="2"><button type="submit" class="btn btn-danger btn-md  col-md-offset-6" >创建课程</button></td>
                </tr>
            </table>
        </form>
    ...
    <c:if test="${editor!=null}">
        <div class="col-md-8 report-item clearfix" style="font-size: larger">
            <form class="form-select" method="post" action="/student/update">
                <input type="hidden" value="${sessionScope.TEACHER.id}" name="id">
            <table style="text-align: justify-all">
                <tr>
                    <td><span style="color: #0ace9d">昵称:</span></td>
                    <td><input type="text" value="${editor.name}" name="name"></td>
                </tr>
                <tr>
                    <td><span style="color: #0ace9d">绑定邮箱：</span></td>
                    <td><input type="email" value="${editor.email}" name="email"></td>
                </tr>
                <tr>
                    <td><span style="color: #0ace9d">性别:</span></td>
                    <td>男<input type="radio" value="男"name="sex" checked="${editor.sex=='男'?'true':'false'}" >   女<input type="radio" value="女" name="sex" checked="${editor.sex=='女'?'true':'false'}" ></td>
                </tr>
                <tr>
...
<div id="jinja-data"
    ...
    <script type="text/javascript" src=/static/assets/js/checkupload.js"></script>
