    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="header-navbar-collapse">
            ...
            <div class="navbar-right btns">
                ...
                <li class="dropdown ">
                    <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="/upload/${sessionScope.STUDENT.image}" width="40" height="50">
                        <span class="caret"></span>
                    </a>
                    <ul class="dropdown-menu">
...
<div class="userinfo-banner layout-no-margin-top">
    ...
    <div class="user-avatar ">
            <img src="/upload/${sessionScope.STUDENT.image}" width="80" height="100">
    </div>
                </div>
        ...
        <a class="username" href="/user/13" target="_blank">
            ${sessionScope.STUDENT.name}
                    ...
                    <div class="userinfo-banner-status">
                            <span>${sessionScope.STUDENT.sex}</span>
                    </div>
                </div>
            </div>
...
<div class="content">
    ...
    <ul class="nav nav-tabs" rolw="tablist">
        <li role="presentation"  class="active">
            <a href="/student/info" role="tab">个人资料</a>
        </li>
        <li role="presentation">
            <a href="/student/mycourses/${sessionScope.STUDENT.id}" role="tab">我的收藏</a>
        </li>
...
<c:if test="${editor==null}">
    <div class="col-md-8 report-item clearfix" style="font-size: larger">
       <table style="text-align: justify-all">
           <tr>
               <td><span style="color: #0ace9d">我的头像:   </span></td>
               <td> <img src="/upload/${sessionScope.STUDENT.image}" width="45" height="50"></td>
           </tr>
           <tr>
           ...
           <tr>
               <td><span style="color: #0ace9d">账号创建时间：</span></td>
               <td><fmt:formatDate  value="${sessionScope.STUDENT.createTime}" pattern="yyyy年MM月dd日 HH时mm分ss秒"/></td>
           </tr>
       </table>
    </div>
    <div class="col-md-2" style="font-size: larger">
        <br><br>
        <a href="/student/updateInfo/${sessionScope.STUDENT.id}">修改个人资料</a>
    </div>
</c:if>
    <c:if test="${editor!=null}">
        <div class="col-md-8 report-item clearfix" style="font-size: larger">
