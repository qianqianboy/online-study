...
<div class="col-md-4 col-sm-6  course">
    <a class="course-box" href="/course/findById/${cs.course.id}">
        <div class="sign-box">
        </div>
        <div class="course-img">
            <img alt="${cs.course.title}" src="/upload/${cs.course.image}">
        </div>
        <div class="course-body">
            <span class="course-title" data-toggle="tooltip" data-placement="bottom" title="${cs.course.title}">${cs.course.title}</span>
        </div>
        <div class="course-footer">
			<span class="course-per-num pull-left">
                <i class="fa fa-users"></i>
                收藏量：${cs.course.followedNum}
			</span><span class="course-per-num pull-right">
                <i class="fa fa-users"></i>
                作者：${cs.course.teacher.name}
			</span>
        </div>
    </a>
</div>
