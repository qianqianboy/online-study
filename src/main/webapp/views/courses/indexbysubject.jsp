        ...
        <div class="col-md-9 layout-body">
            <div class="content">
                <div class="row course-cates">
                    ...
                    <div class="col-md-11 course-cates-content">
                        ...
                        <a class="" href="/course/show/1">全部</a>

                        <a  class= "${subject.title=='Python'? 'active': ''|| subject1.title=='Python'?'active':''}" href="/subject/findByTitle/Python/1">Python</a>

                        <a class="${subject.title=='C++'? 'active': ''|| subject1.title=='C++'?'active':''}" href="/subject/findByTitle/C++/1">C++</a>

                        <a class="${subject.title=='Linux'? 'active': '' || subject1.title=='Linux'?'active':''}" href="/subject/findByTitle/Linux/1">Linux</a>

                        <a class="${subject.title=='Web'? 'active': '' || subject1.title=='Web'?'active':''}" href="/subject/findByTitle/Web/1">Web</a>

                        <a class="${subject.title=='PHP'? 'active': '' || subject1.title=='PHP'?'active':''}" href="/subject/findByTitle/PHP/1">PHP</a>

                        <a class="${subject.title=='Java'? 'active': ''||subject1.title=='Java'?'active':''}" href="/subject/findByTitle/Java/1">Java</a>

                        <a class="${subject.title=='NodeJS'? 'active': '' || subject1.title=='NodeJS'?'active':''}" href="/subject/findByTitle/NodeJS/1">NodeJS</a>

                        <a class="${subject.title=='Android'? 'active': '' || subject1.title=='Android'?'active':''}" href="/subject/findByTitle/Android/1">Android</a>

                        <a class="${subject.title=="GO"? "active": "" || subject1.title=='GO'?'active':''}" href="/subject/findByTitle/GO/1">GO</a>

                        <a class="${subject.title=='Spark'? 'active': '' || subject1.title=='Spark'?'active':''}" href="/subject/findByTitle/Spark/1">Spark</a>

                        <a class="${subject.title=='Hadoop'? 'active': ''|| subject1.title=='Hadoop'?'active':''}" href="/subject/findByTitle/Hadoop/1">Hadoop</a>

                        <a class="${subject.title=='HTML5'? 'active': '' || subject1.title=='HTML5'?'active':''}"href="/subject/findByTitle/HTML5/1">HTML5</a>

                        <a class="${subject.title=='Scala'? 'active': '' || subject1.title=='Scala'?'active':''}" href="/subject/findByTitle/Scala/1">Scala</a>

                        <a class="${subject.title=='Ruby'? 'active': '' || subject1.title=='Ruby'?'active':''}" href="/subject/findByTitle/Ruby/1">Ruby</a>

                        <a class="${subject.title=='R'? 'active': '' || subject1.title=='R'?'active':''}" href="/subject/findByTitle/R/1">R</a>

                        <a class="${subject.title=='Git'? 'active': '' || subject1.title=='Git'?'active':''}" href="/subject/findByTitle/Git/1">Git</a>

                        <a class="${subject.title=='SQL'? 'active': '' || subject1.title=='SQL'?'active':''}" href="/subject/findByTitle/SQL/1">SQL</a>

                        <a class="${subject.title=='NoSQL'? 'active': '' || subject1.title=='NoSQL'?'active':''}" href="/subject/findByTitle/NoSQL/1">NoSQL</a>

                        <a class="${subject.title=='算法'? 'active': '' || subject1.title=='算法'?'active':''}" href="/subject/findByTitle/算法/1">算法</a>

                        <a class="${subject.title=='Docker'? 'active': '' || subject1.title=='Docker'?'active':''}"  href="/subject/findByTitle/Docker/1">Docker</a>

                        <a class="${subject.title=='Swift'? 'active': '' || subject1.title=='Swift'?'active':''}" href="/subject/findByTitle/Swift/1">Swift</a>

                        <a class="${subject.title=='区块链'? 'active': '' || subject1.title=='区块链'?'active':''}" href="/subject/findByTitle/区块链/1">区块链</a>

                        <a class="${subject.title=='Windows'? 'active': ''|| subject1.title=='Windows'?'active':''}" href="/subject/findByTitle/Windows/1">Windows</a>
            ...
            <div class="content position-relative">
                <ul class="nav nav-tabs" role="tablist">
                        <li class="${hottest==null? 'active':''}"><a href="/subject/findByTitle/${subject.title}${subject1.title}/${pageInfo.pageNum}">最新</a></li>
                        <li class="${hottest!=null? 'active':''}"><a href="/course/showHottest/${subject.id}${subject1.id}/${pageInfo.pageNum}">最热</a></li>
                    ...
                    <ul class="pagination">
                        ...
                        <c:if test="${subject!=null}">
                            <c:if test="${pageInfo.pageNum==1}">
                                <li class="disabled">
                                    <a href="/subject/findByTitle/${subject.title}/${pageInfo.pageNum}"  aria-label="Previous">
                            ...
                            <c:if test="${pageInfo.pageNum!=1}">
                                <li>
                                    <a href="/subject/findByTitle/${subject.title}/${pageInfo.prePage}" aria-label="Previous">
                                        <span aria-hidden="true">上一页</span>
                                    </a>
                                </li>
                            </c:if>
                            ...
                            <li class="active disabled">
                                <a href="/subject/findByTitle/${subject.title}/${pageInfo.pageNum}" name="page">${pageInfo.pageNum}</a>
                            </li>


                            <c:if test="${pageInfo.isLastPage}">
                                <li class="disabled">
                                    <a href="/subject/findByTitle/${subject.title}/${pageInfo.pages}"  aria-label="Previous">
                            ...
                            <c:if test="${!pageInfo.isLastPage}">
                                <li>
                                    <a aria-label="Next" href="/subject/findByTitle/${subject.title}/${pageInfo.nextPage}">
                                        <span aria-hidden="true">下一页</span>
                                    </a>
                                <li>
                            </c:if>
                        ...
                        <c:if test="${subject1!=null}">
                            <c:if test="${pageInfo.pageNum==1}">
                                <li class="disabled">
                                    <a href="/course/showHottest/${subject1.id}/${pageInfo.pageNum}"  aria-label="Previous">
                                        <span aria-hidden="true" >上一页</span>
                                    </a>
                                </li>
                            </c:if>
                            <c:if test="${pageInfo.pageNum!=1}">
                                <li>
                                    <a href="/course/showHottest/${subject1.id}/${pageInfo.prePage}" aria-label="Previous">
                                        <span aria-hidden="true">上一页</span>
                                    </a>
                                </li>
                            </c:if>
                            ...
                            <li class="active disabled">
                                <a href="/course/showHottest/${subject1.id}/${pageInfo.pageNum}" name="page">${pageInfo.pageNum}</a>
                            </li>


                            <c:if test="${pageInfo.isLastPage}">
                                <li class="disabled">
                                    <a href="/course/showHottest/${subject1.id}/${pageInfo.pages}"  aria-label="Previous">
                                        <span aria-hidden="true" >下一页</span>
                                    </a>
                                </li>
                            </c:if>
                            <c:if test="${!pageInfo.isLastPage}">
                                <li>
                                    <a aria-label="Next" href="/course/showHottest/${subject1.id}/${pageInfo.nextPage}">
                                        <span aria-hidden="true">下一页</span>
                                    </a>
                                <li>
                            </c:if>
        ...
        <div class="col-md-3 layout-side">
            ...
            <div class="sidebox">
                ...
                <div class="sidebox-header">
                    <h4 class="sidebox-title">最新/热课程</h4>
                </div>
                <div class="sidebox-body course-content side-list-body">
                    <c:forEach items="${pageInfo.list}" var="c">
                        <a href="/course/findById/${c.id}"><img style="width:25px;height:25px" src="/test/${c.image}">${c.title}</a>
                    </c:forEach>
                </div>
