...
<nav class="pagination-container">
    <ul class="pagination">
            ...
            <c:if test="${pageInfo.pageNum==1}">
                <li class="disabled">
                <a href="/course/show/1"  aria-label="Previous">
            ...
            <c:if test="${pageInfo.pageNum!=1}">
                <li>
                <a href="/course/show/${pageInfo.prePage}" aria-label="Previous">
                    <span aria-hidden="true">上一页</span>
                </a>
                </li>
            </c:if>
        ...
        <li class="active disabled">
            <a href="/course/show/${pageInfo.pageNum}" name="page">${pageInfo.pageNum}</a>
        </li>

            <c:if test="${pageInfo.isLastPage}">
        <li class="disabled">
                <a href="/course/show/${pageInfo.pages}" class="disabled" aria-label="Previous">
            ...
            <c:if test="${!pageInfo.isLastPage}">
                <li>
                <a aria-label="Next" href="/course/show/${pageInfo.nextPage}">
                    <span aria-hidden="true">下一页</span>
                </a>
                </li>
            </c:if>
...
<c:if test="${hottest!=null}">
    <ul class="nav nav-tabs" role="tablist">
    <li class=""}><a href="/course/show/${pageInfo.pageNum}">最新</a></li>
    <li class="active"><a href="/course/showByPopular/${pageInfo.pageNum}">最热</a></li>
    </ul>
    <div class="clearfix"></div>
    <div class="search-result"></div>
    <div class="row">
    ...
    <c:if test="${pageInfo.pageNum==1}">
        <li class="disabled">
            <a href="/course/showByPopular1"  aria-label="Previous">
                <span aria-hidden="true">上一页</span>
            </a>
        </li>
    </c:if>
    <c:if test="${pageInfo.pageNum!=1}">
        <li>
            <a href="/course/showByPopular/${pageInfo.prePage}" aria-label="Previous">
                <span aria-hidden="true">上一页</span>
            </a>
        </li>
    </c:if>
    ...
    <li class="active disabled">
    <a href="/course/showByPopular/${pageInfo.pageNum}" name="page">${pageInfo.pageNum}</a>
    </li>

    <c:if test="${pageInfo.isLastPage}">
        <li class="disabled">
            <a href="/course/showByPopular/${pageInfo.pages}" class="disabled" aria-label="Previous">
                <span aria-hidden="true">下一页</span>
            </a>
        </li>
    </c:if>
    <c:if test="${!pageInfo.isLastPage}">
        <li>
            <a aria-label="Next" href="/course/showByPopular/${pageInfo.nextPage}">
                <span aria-hidden="true">下一页</span>
            </a>
        </li>
    </c:if>
...
<div class="panel panel-default panel-userinfo">
    <div class="panel-body body-userinfo">
        ...
        <%--<div class="row userinfo-data">--%>
            ...
            <%--<a href="/" type="button" class="btn btn-success col-md-5 col-xs-6 login-btn" data-toggle="modal" data-sign="signin">登录</a>--%>
                    ...
                    <div role="tabpanel" class="tab-pane active" id="signin-form">
                        ...
                        <form action="/student/login" method="post">
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input type="email" name="email" class="form-control" placeholder="请输入邮箱1">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input type="password" name="password" class="form-control" placeholder="请输入密码1">
                                </div>
                            </div>
                        ...
                        <%--<form action="/student/login" method="post"  >--%>
                            ...
                            <%--<div class="form-group">--%>
                                <%--<input class="btn btn-primary" type="submit" value="登录">--%>
                            <%--</div>--%>
                            <%--&lt;%&ndash;<div class="form-group error-msg">&ndash;%&gt;--%>
                                <%--&lt;%&ndash;<div class="alert alert-danger" role="alert"></div>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
                        <%--</form>--%>
                    </div>
